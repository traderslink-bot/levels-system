...
- Discord level snapshots now include a nearest support/resistance map line plus signed distance-from-price context beside each ladder level, so the snapshot reads more like a usable trade map than a bare price list.
