...
- Testing-only Discord threads can be previewed or cleaned with `npm run discord:cleanup:threads -- --dry-run`; mutating archive/delete cleanup requires `--confirm-testing-cleanup`.
